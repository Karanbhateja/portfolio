...
const Terminal = (() => {
    ...
    function prompt(cmd) {
        print(`<span class="t-prompt">karan@portfolio:~$</span> <span class="t-cmd">${escHtml(cmd)}</span>`);
    }
    ...
    function showBanner() {
        ...
        nl();
        print(`<span class="t-dim">Type <span class="t-cyan">help</span> to see available commands.</span>`);
        nl();
    }
    ...
    const commands = {
        ...
        help() {
            ...
            cmds.forEach(([cmd, desc]) => {
                print(`  <span class="t-cyan">${cmd.padEnd(12)}</span><span class="t-dim">—</span> <span class="t-white">${desc}</span>`);
            });
            nl();
        },
        ...
        about() {
            nl();
            print(`<span class="t-cyan">[ About Me ]</span>`);
            nl();
        ...
        skills() {
            ...
            nl();
            print(`<span class="t-cyan">[ Tools & Platforms ]</span>`);
            ...
            nl();
            print(`<span class="t-cyan">[ Other ]</span>`);
        ...
        projects() {
            ...
            projs.forEach(p => {
                print(`<span class="t-cyan">┌─[</span><span class="t-green">${p.icon} PROJECT-${p.id}</span><span class="t-cyan">]</span>`);
                print(`<span class="t-cyan">│</span> <span class="t-white">${p.name}</span>`);
                print(`<span class="t-cyan">│</span> <span class="t-dim">${p.desc}</span>`);
                print(`<span class="t-cyan">│</span> Tags: ${p.tags.map(t => `<span class="t-tag">${t}</span>`).join(' ')}`);
                if (p.link) {
                    print(`<span class="t-cyan">│</span> <span class="t-cyan"><a href="${p.link}" target="_blank">${p.link}</a></span>`);
                }
                print(`<span class="t-cyan">└──────────────────────────────</span>`);
                nl();
            });
        ...
        contact() {
            nl();
            print(`<span class="t-cyan">[ Contact Information ]</span>`);
            nl();
            print(`  <span class="t-green">► GitHub :</span> <span class="t-cyan"><a href="https://github.com/karanbhateja" target="_blank">github.com/karanbhateja</a></span>`);
